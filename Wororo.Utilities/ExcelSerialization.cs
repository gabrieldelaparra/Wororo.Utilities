...
namespace Wororo.Utilities
{
    ...
    {
        private static (string[] header, IEnumerable<string[]> rows) SplitHeaderAndRows(IEnumerable<string> input, char separator = ',')
        {
        ...
        public static IEnumerable<IDictionary<string, object>> ToTableDictionary(IEnumerable<string> input, char separator = ',')
        {
        ...
        private static void ToExcel(IEnumerable<IDictionary<string, object>> dictionary, string outputFilename, string sheetName = "Sheet1")
        {
        ...
        public static void CSVToExcel(IEnumerable<string> input, string outputFilename, bool hasHeader = true, char separator = ',', string sheetName = "Sheet1")
        {
