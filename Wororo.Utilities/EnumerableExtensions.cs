...
namespace Wororo.Utilities
{
    public static class EnumerableExtensions
    {
        ...
        public static (IEnumerable<T> TrueSlice, IEnumerable<T> FalseSlice) SliceBy<T>(this IEnumerable<T> enumerable, Predicate<T> predicate)
        {
            //Via MoreEnumerable.Partition
            return enumerable.Partition(x => predicate(x));
        }

        public static (IEnumerable<T> FirstPart, IEnumerable<T> SecondPart) Split<T>(this IEnumerable<T> enumerable, int fromZeroTo)
        {
